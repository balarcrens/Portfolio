...
export default function BlackHole() {
  ...
  return (
    <section
      id="singularity"
      ref={sectionRef}
      className="relative w-full h-screen bg-[#000000] overflow-hidden select-none"
    >
      {/* Immersive WebGPU Canvas Context */}
      {webgpuSupported ? (
        <div ref={containerRef} className="absolute inset-0 z-0 pointer-events-auto" />
      ) : (
        /* Minimalist fallback message */
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-black/50 via-transparent to-black/75 pointer-events-none z-1" />
    </section>
  );
}
