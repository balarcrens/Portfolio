        ...
        const ctx = gsap.context(() => {
            ...
            const tl = gsap.timeline({
                scrollTrigger: {
                    ...
                    start: "top 100%", // triggers when the top of the section hits 75% of the viewport height
        ...
        >
            ...
            <div className="max-w-[90rem] w-full grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center relative z-10">
                ...
                <div ref={textContainerRef} className="flex flex-col justify-center space-y-8">
                    ...
                    <div className="overflow-hidden">
                        <p className="stagger-reveal text-lg text-gray-400 font-light leading-relaxed max-w-xl">
                            I am <span className="text-white font-medium">Crens Pravinbhai Balar</span>, a Full-Stack Developer specializing in MERN and PERN technologies. I build scalable web applications with a strong focus on performance, maintainability, and user experience. From designing responsive interfaces to developing robust backend systems, I create solutions that are efficient, reliable, and built for growth.
                        </p>
                    </div>
                    ...
                    <div className="overflow-hidden mt-6">
                        <blockquote className="stagger-reveal border-l-2 border-red-500/50 pl-6 py-2">
                            <p className="text-xl md:text-2xl text-gray-200 font-serif italic">
                                “Building scalable solutions through clean code,
